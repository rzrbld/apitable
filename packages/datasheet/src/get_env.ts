...
export const getEnvVars = () => {
  return {
    OIDC_URI_GRANT_TYPE_PASSWORD: process.env.OIDC_URI_GRANT_TYPE_PASSWORD,
    OIDC_IMPLICIT_SUCCESS_REDIRECT: process.env.OIDC_IMPLICIT_SUCCESS_REDIRECT, 
    OIDC_IMPLICIT_JWKS_URI: process.env.OIDC_IMPLICIT_JWKS_URI,
    OIDC_IMPLICIT_IS_ENABLED: process.env.OIDC_IMPLICIT_IS_ENABLED,
    OIDC_IMPLICIT_URL: process.env.OIDC_IMPLICIT_URL,
    OIDC_IMPLICIT_REDIRECT_URL: process.env.OIDC_IMPLICIT_REDIRECT_URL,
    OIDC_IMPLICIT_CLIENT_ID: process.env.OIDC_IMPLICIT_CLIENT_ID,
    OIDC_IMPLICIT_RESPONSE_TYPE: process.env.OIDC_IMPLICIT_RESPONSE_TYPE, 
    OIDC_IMPLICIT_SCOPE: process.env.OIDC_IMPLICIT_SCOPE,
